        ...
        <div>
            ...
            <Form className='p-4 border rounded mx-4 my-4'onSubmit={handleSubmit}>
                ...
                <FloatingLabel controlId="floatingPassword" label="Phone" className="my-3">
                    <Form.Control type="text" name="phone" value={customerData.phone} onChange={handleChange} placeholder="111-222-3333" />
                </FloatingLabel>
                <FloatingLabel controlId="floatingPassword" label="Email">
                    <Form.Control type="email" name="email" value={customerData.email} onChange={handleChange} placeholder="name@example.com" />
                </FloatingLabel>
